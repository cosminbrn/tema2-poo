...
public enum ErrorMessages {
    ...
    REQUIRED_ROLE_DEVELOPER("The user does not have permission to execute this command: required role DEVELOPER; user role %s."),
    DEVELOPER_LACKS_EXPERTISE("Developer %s cannot assign ticket %d due to expertise area. Required: %s; Current: %s."),
    DEVELOPER_LACKS_SENIORITY("Developer %s cannot assign ticket %d due to seniority level. Required: %s; Current: %s."),
